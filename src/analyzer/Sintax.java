      ...
      switch (CUP$Sintax$act_num)
		...
		RESULT = start_val;
          ...
          case 11: // CREACION ::= TIPO Identificador Numeral 
            {
              Object RESULT =null;
		int id_varleft = ((java_cup.runtime.Symbol)CUP$Sintax$stack.elementAt(CUP$Sintax$top-1)).left;
		int id_varright = ((java_cup.runtime.Symbol)CUP$Sintax$stack.elementAt(CUP$Sintax$top-1)).right;
		Object id_var = (Object)((java_cup.runtime.Symbol) CUP$Sintax$stack.elementAt(CUP$Sintax$top-1)).value;
...
//        TablaSimbolos.tablaSimbolos.add(id_var, id_varleft, id_varright);
        ...
        System.out.println(tablaSimbolos.getTablaSimbolos());
          ...
          case 12: // CREAASIG ::= TIPO Identificador Igual TIPOASIG Numeral 
            {
              Object RESULT =null;
		int _idleft = ((java_cup.runtime.Symbol)CUP$Sintax$stack.elementAt(CUP$Sintax$top-3)).left;
		int _idright = ((java_cup.runtime.Symbol)CUP$Sintax$stack.elementAt(CUP$Sintax$top-3)).right;
		Object _id = (Object)((java_cup.runtime.Symbol) CUP$Sintax$stack.elementAt(CUP$Sintax$top-3)).value;
